...
//        } else {
     ...
     * @param writeText
     */
    public static File writeToFile(File file, String writeText){
        return writeToFile(file, writeText, false);
    }

    public static File writeToFile(File file, String writeText, boolean append){
