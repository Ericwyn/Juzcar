...
public class SimpleHttpServer {
    ...
    public void start() throws WebServerException {
        ...
        // TODO 静态资源文件，应该怎么办呢，这里直接注释掉了
//        File rootDir = new File(WEB_ROOT);
//        if (!rootDir.isDirectory()){
//
//            // 获取当前运行的文件夹，用 getResourceAsStream 方式读取静态资源文件
//            // 在当前资源运行文件夹里面创建
//            URL staticPath = SimpleHttpServer.class.getClassLoader().getResource("static");
//            System.out.println(staticPath.getFile());
